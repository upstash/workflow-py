...
class AsyncClient:
    """
    Async Workflow client for canceling & notifying workflows and getting waiters of an event.
    ...
    def __init__(self, token: str, base_url: Optional[str] = None):
        """
        Initialize the Async Workflow client.
        ...
        self.client = AsyncQStash(**kwargs)

...
const routes = ["/api/py/sleep", "/api/py/call", "/api/py/auth"];
...
const Page = () => {
  ...
  const [route, setRoute] = useState(search ?? "/api/py/sleep");
  const [authentication, setAuthentication] = useState("secret_password");
            ...
            <StepContent>
              ...
              >
                ...
                <div>
                  <button
                    disabled={loading}
                    className={`h-8 rounded-md bg-emerald-500 px-4 text-white ${
                      loading ? "opacity-30" : ""
                    }`}
                  >
